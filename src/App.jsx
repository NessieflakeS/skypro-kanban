                  ...
                  <div className="calendar__block">
                    ...
                    <div className="calendar__content">
                      ...
                      <div className="calendar__cells">
                        ...
                        <div className="calendar__cell _cell-day">9</div>
                        <div className="calendar__cell _cell-day">10</div>
                        ...
                        <div className="calendar__cell _cell-day">16</div>
                        <div className="calendar__cell _cell-day">17</div>
                        ...
                        <div className="calendar__cell _cell-day">23</div>
                        <div className="calendar__cell _cell-day">24</div>
                        ...
                        <div className="calendar__cell _cell-day">30</div>
                        <div className="calendar__cell _other-month">1</div>
                      </div>
                    </div>
                  ...
                  <div className="calendar__block">
                    ...
                    <div className="calendar__content">
                      ...
                      <div className="calendar__cells">
                        ...
                        <div className="calendar__cell _cell-day">7</div>
                        <div className="calendar__cell _cell-day _current">8</div>
                        <div className="calendar__cell _cell-day _active-day">9</div>
                        <div className="calendar__cell _cell-day">10</div>
                        <div className="calendar__cell _cell-day">11</div>
                        <div className="calendar__cell _cell-day">12</div>
                        <div className="calendar__cell _cell-day">13</div>
